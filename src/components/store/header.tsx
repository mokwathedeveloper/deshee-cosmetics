      ...
      <div className="bg-background border-b border-border/40 py-1.5">
        <div className="container flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-[10px] font-bold uppercase tracking-widest">
            ...
            <Link href="/admin/login" className="text-xs text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-sm">
              Admin
            </Link>
          </div>
        </div>
